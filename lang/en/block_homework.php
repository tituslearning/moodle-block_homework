...
$string['archiveafterdays'] = 'Archive after days';
$string['archiveafterdays_help'] = 'Number of days after the due date when this homework assignment will be moved to the archive section of the course.';
